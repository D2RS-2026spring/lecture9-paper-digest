...
1.  **文件上传与解析：**
    ...
    -   通过 API 上传文件，文件格式与大小限制请参考[支持格式](#3900d28abb8dx)。
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   | **（每千Token）** |   |
| **qwen-long** | 稳定版 | 10,000,000 | 10,000,000 | 32,768 | 0.0005元 [Batch调用](https://help.aliyun.com/zh/model-studio/batch-interfaces-compatible-with-openai/)半价 | 0.002元 [Batch调用](https://help.aliyun.com/zh/model-studio/batch-interfaces-compatible-with-openai/)半价 | 各100万Token 有效期：百炼开通后90天内 |
